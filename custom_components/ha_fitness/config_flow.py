...
class HAFitnessOptionsFlow(config_entries.OptionsFlow):
    ...
    async def async_step_manage_persons(
        ...
        # description_placeholders is the ONLY way to show dynamic content
        # in async_show_form() that HA 2025.x accepts.
        # The translation template must have: "placeholder": "{{ person_table }}"
        # and description_placeholders must provide the value for "person_table".
        return self.async_show_form(
            data_schema=vol.Schema({}),
